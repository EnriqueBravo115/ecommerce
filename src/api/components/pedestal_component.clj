...
;; funcion helper para crear respuestas http estandarizadas
(defn response
  ([status]
   (response status nil))
  ([status body]
...
;; shortcuts para respuestas comunes
...
;; usa un atomo para almacenar los todos
...
;; usa honeysql para construir consultas sql
;; convierte los resultados a mapas con claves en kebab-case
